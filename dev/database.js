const skills = [
  { name: "Python", progress: 85, title: "Intermediate" },
  { name: "JavaScript", progress: 80, title: "Intermediate" },
  { name: "HTML/CSS", progress: 95, title: "Advanced" },
  { name: "SQL", progress: 60, title: "Beginner" },
  { name: "C", progress: 90, title: "Intermediate" },
  { name: "React", progress: 55, title: "Beginner" },
  { name: "Machine Learning", progress: 50, title: "Beginner" },
  { name: "AI", progress: 45, title: "Pretty Beginner" },
  { name: "Django(REST)", progress: 80, title: "Intermediate" },
  { name: "R", progress: 70, title: "Intermediate" },
  { name: "Java", progress: 70, title: "Intermediate" },
];
